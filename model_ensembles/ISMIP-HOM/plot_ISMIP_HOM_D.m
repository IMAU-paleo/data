...
[HO,FS] = process_ISMIP_HOM_ensemble_experiment_D( 'ismip_all');
...
set( H.Ax{ 1,2},'ylim',[15,18]);
set( H.Ax{ 1,3},'ylim',[14,24]);
set( H.Ax{ 2,1},'ylim',[10,50]);
set( H.Ax{ 2,2},'ylim',[0,140]);
set( H.Ax{ 2,3},'ylim',[0,300]);
